  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <DocCard>
        ...
        <Prose>
          A single Next.js Route Handler at <Mono>/api/graphql</Mono> delegates to GraphQL Yoga. Schema-first — the SDL and resolvers are co-located in route.ts (~950 lines). Each resolver makes direct Drizzle queries; there is no DataLoader or batching layer.
        </Prose>
      </DocCard>
