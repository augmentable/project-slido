      ...
      <div className="max-w-2xl w-full space-y-5">
        ...
        <div className="flex items-start justify-between flex-wrap gap-3 pb-4 animate-fade-in" style={{ borderBottom: '1px solid var(--border)' }}>
          ...
          <div className="flex items-center gap-3 shrink-0">
            <Link to={`/session/${code}/present`} className="inline-flex items-center gap-1 text-xs tracking-wider uppercase hover:underline" style={{ color: 'var(--success)' }}>
              <span aria-hidden="true">▶</span>
              Enlarge
            </Link>
            <Link to={`/session/${code}/settings`} className="text-base leading-none hover:opacity-80" style={{ color: 'var(--text-muted)' }} title="Settings" aria-label="Settings">
              <span aria-hidden="true">⚙</span>
            </Link>
          </div>
        </div>
